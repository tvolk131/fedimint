...
mod tests {
    ...
    #[test]
    fn test_derive_enum_custom_index() {
    ...
    fn test_lexicographical_sorting() {
        fn assert_keeps_ordering_after_serialization<T: Ord + Encodable + Decodable + Debug>(
            mut vec: Vec<T>,
        ) {
            vec.sort();
            ...
            let decoded = encoded
                .iter()
                .map(|bytes| {
                    T::consensus_decode_vec(bytes.as_ref(), &ModuleDecoderRegistry::default())
                        .unwrap()
                })
                .collect::<Vec<_>>();
        ...
        assert_keeps_ordering_after_serialization(amounts);
        ...
        let complex_amounts = (10..20000)
            ...
            .collect::<Vec<_>>();
        assert_keeps_ordering_after_serialization(complex_amounts);
        ...
        let texts = (' '..'~')
            ...
            .collect::<Vec<_>>();
        assert_keeps_ordering_after_serialization(texts);
